...
CREATE TABLE `entries` (
  ...
  KEY `entries_category_id_foreign` (`category_id`),
  CONSTRAINT `entries_category_id_foreign` FOREIGN KEY (`category_id`) REFERENCES `categories` (`id`) ON DELETE SET NULL,
...
-- Dump completed on 2020-01-26 21:01:11
