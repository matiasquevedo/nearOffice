						...
						<div class="wrap">
							...
							<div class="manage-menus">
								<form method="get" action="{{ $currentUrl }}">
									<label for="menu" class="selected-menu">Seleccionar un menu:</label>

									{!! Menu::select('menu', $menulist) !!}

									<span class="submit-btn">
										<input type="submit" class="button-secondary" value="Cambiar">
									</span>
									<span class="add-new-menu-action"> o <a href="{{ $currentUrl }}?action=edit&menu=0">Crear un nuevo menu</a>. </span>
								</form>
							</div>
										...
										<div id="side-sortables" class="accordion-container">
											<ul class="outer-border">
												<li class="control-section accordion-section  open add-page" id="add-page">
													<h3 class="accordion-section-title hndle" tabindex="0"> Agregar Link al menu <span class="screen-reader-text">Press return or enter to expand</span></h3>
														...
														<div class="inside">
															<div class="customlinkdiv" id="customlinkdiv">
																...
																<p id="menu-item-name-wrap">
																	<label class="howto" for="custom-menu-item-name"> <span>Etiqueta</span>&nbsp;
																		<input id="custom-menu-item-name" name="label" type="text" class="regular-text menu-item-textbox input-with-default-title" title="Label menu" placeholder="Etiqueta">
																	</label>
																</p>
											...
											<div class="menu-edit ">
												<div id="nav-menu-header">
													<div class="major-publishing-actions">
														<label class="menu-name-label howto open-label" for="menu-name"> <span>Nombre del Menu</span>
												...
												<div id="post-body">
													<div id="post-body-content">
														...
														<div class="drag-instructions post-body-plain" style="">
															<p>
																Coloque cada artículo en el orden que prefiera. Haga clic en la flecha a la derecha del elemento para mostrar más opciones de configuración.
															</p>
														</div>
														{{-- <div>
															<input type="checkbox" name="nav" value="1">Menu de página de inicio<br>
														</div> --}}
														...
														<div class="drag-instructions post-body-plain" style="">
															<p>
																Ingrese el nombre y seleccione el botón "Crear menú"
															</p>
														</div>
														@endif
												...
												<div id="nav-menu-footer">
													<div class="major-publishing-actions">
														...
														@elseif(request()->has("menu"))
														<span class="delete-action"> <a class="submitdelete deletion menu-delete" onclick="deletemenu()" href="javascript:void(9)">Eliminar Menu</a> </span>
														<div class="publishing-action">
